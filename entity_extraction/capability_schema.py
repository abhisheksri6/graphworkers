...
CAPABILITY_SCHEMA: Dict[str, Any] = {
    ...
    "input_fields": {
        ...
        "entity_extraction_config.gazetteer_enabled": {"type": "boolean", "required": "optional",
                                                       "description": "Opt-in GLEIF/LEI gazetteer (default false)"},
        "entity_extraction_config.gazetteer_sources": {"type": "array", "required": "optional",
                                                       "description": "Gazetteer sources (default [gleif_lei])"},
        "entity_extraction_config.entity_linking": {"type": "boolean", "required": "optional",
                                                    "description": "Write external_id (LEI) on gazetteer matches"},
    ...
    "output_fields": {
        ...
        "linked_count": {"type": "integer", "always_present": True,
                         "description": "Entities carrying an external_id (gazetteer link)"},
    },
    "artifact_inputs": {
